...
const string strMessageMagic = "StopLoss Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "StopLoss", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Sat, 24 Jan 2015 12:37:24 GMT";
        CTransaction txNew;
        txNew.nTime = 1422103044;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1422103049;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 5959481;
		if(fTestNet)
        {
            block.nNonce   = 5959481;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x2721c4892feec7fd96e76adfdcae8f80d891c20ddbb3bb12f1c16729ddca20fd"));
        block.print();
